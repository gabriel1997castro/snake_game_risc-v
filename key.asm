...
### Espera o usuï¿½rio pressionar uma tecla
KEY1: 	li t1,0xFF200000		# carrega o endereï¿½o de controle do KDMMIO
LOOP: 	lw t0,0(t1)			# Le bit de Controle Teclado
   	andi t0,t0,0x0001		# mascara o bit menos significativo
   	beq t0,zero,LOOP		# nï¿½o tem tecla pressionada entï¿½o volta ao loop
   	lw t2,4(t1)			# le o valor da tecla
  	sw t2,12(t1)  			# escreve a tecla pressionada no display
	ret				# retorna

### Apenas verifica se hï¿½ tecla pressionada
KEY2:	li t1,0xFF200000		# carrega o endereï¿½o de controle do KDMMIO
